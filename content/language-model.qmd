...
The *attention* mechanism addresses this issue by stacking the input in a matrix such that they can all be processed at the same time. According to the paper "Attention is all you need" [@vaswani2017attention], the authors defined the attention function as the following:
...
1. Tokenization (Discussion from @Howard_Gugger_2021)
